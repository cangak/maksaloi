          ...
          <div class="modal-content">
              ...
              <div class="modal-body">
                  <form action="<?= site_url('bill/payment') ?>" method="POST">
                      ...
                      Apakah yakin tagihan dengan ID Pelanggan <?= $bill['no_services'] ?> a/n <b><?= $bill['name'] ?></b> Periode <?= indo_month($bill['month']) ?> <?= $bill['year'] ?> sudah terbayarkan ?, jika sudah silahkan isi tanggal bayar iuran.
                      <br>
                      <br>
                      <div class="form-group">
